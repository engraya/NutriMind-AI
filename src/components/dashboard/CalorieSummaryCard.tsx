...
export function CalorieSummaryCard({ consumed, target }: CalorieSummaryCardProps) {
  ...
  const data = [{ value: percent, fill: "var(--color-primary)" }];

  return (
    <Card className="border-t-2 border-t-primary shadow-soft hover:shadow-medium transition-shadow duration-300">
